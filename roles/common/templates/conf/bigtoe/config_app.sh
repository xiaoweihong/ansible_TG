...
configVse () {
    ...
    cd $WORK_DIR/pkg/k8s-conf/deepengine/vse/
    ls vse-daemonset-*|xargs -i kubectl replace -f {};
    ls vse-configmap-*|xargs -i kubectl replace -f {} ;
}
...
main
/opt/bigtoe/restart_pods.sh vse
